...
# =======================================================================================================================
def get_price_data_ngd(symbol, snapshot_date):
    """
...
def find_stats_for_one_criteria_one_score(ms_df, duration, criteria_name, score):
    ...
    for symbol in symbols_col:
        # print(symbol)
        try:
            pricedata = get_price_data_ngd(symbol, duration['pricedata_date'])
...
# =======================================================================================================================
def test_datasource_ngd():
    symbol = 'A'
    snapshot_date = '20190506'
    duration = duration_list[0]
    pricedata = get_price_data_ngd(symbol, snapshot_date)
    p1 = pricedata.query('Date==' + duration['start_date'])['Open'].item()
    p2 = pricedata.query('Date==' + duration['end_date'])['Open'].item()
    print(p1, p2)
